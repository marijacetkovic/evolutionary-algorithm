...
public class Config {
    ...
    public static final double STRUCTURAL_MUTATION_RATE = 1;
    ...
    public static double ADD_EDGE_MUTATION_PROB = 0.8;
    ...
    //species management
    public static final double COMPATIBILITY_THRESHOLD = 1.6;
    ...
    public static final double TOURNAMENT_RND_PROB = 0.05;
